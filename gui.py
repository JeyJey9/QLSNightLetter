...
class QLSApp:
    def __init__(self, root):
        ...
        self.label_version.place(relx=0.02, rely=0.96, anchor="w")

        self.label_author = ttk.Label(
            self.root,
            text="grece@ford.com.tr",
            font=("Segoe UI", 9, "italic"),
            background="#d6d6d6"
        )
        self.label_author.place(relx=0.98, rely=0.96, anchor="e")
